...
import questionData from '../assets/dummydata.js';
import {toast} from 'react-toastify'
import axios from 'axios'
import { Award, BookOpen, ChevronDown, ChevronRight, Code, Coffee, Cpu, Database, Globe, Layout, Sparkles, Star, Target, Terminal, Trophy, Zap, Menu, CheckCircle, XCircle, X } from 'lucide-react'
...
// here this function will handle what you select the tech
   const handleTechSelect = (techId) => {
    if (selectedTech === techId) {
      setSelectedTech(null);  //all the inital values are defined here
  ...
  return (
    questionData?.[selectedTech]?.[selectedLevel] || []
  );
};
